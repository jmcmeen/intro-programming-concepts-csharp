...
namespace _08_6_CSharpMinorRemix
{
    /// <summary>
    ...
    internal static class Program
    {
        ...
        static void Main()
        {
            //In previous example, a method for playing an array of notes was introduced
            //In another examples,  we examined playing random notes from an array, but did not use the play notes method
